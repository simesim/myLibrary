// ============================================================
// Моя библиотека — логика приложения
// ============================================================
...
// ---------- CSV PARSING ----------
// Простой, но устойчивый к запятым-в-кавычках парсер CSV.
...
function applyFiltersAndRender() {
  ...
  list.sort((a, b) => {
    switch (sort) {
      ...
      case "author-asc": return a.author.localeCompare(b.author, "ru");
...
function render() {
  ...
  // unless a single genre filter is active or sort is not title — then one shelf.
